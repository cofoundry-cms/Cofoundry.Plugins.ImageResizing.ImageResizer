...
Task("Restore-NuGet-Packages")
    ...
    .Does(() =>
{
    NuGetRestore("./src/Cofoundry.Plugins.ImageResizing.ImageResizer.sln");
});
    ...
    .Does(() =>
{
    ...
    Information("Building version {0} of Cofoundry.Plugins.ImageResizing.ImageResizer.", versionInfo.InformationalVersion);
    ...
    .Does(() =>
{
    ...
    {
      // Use MSBuild
      MSBuild("./src/Cofoundry.Plugins.ImageResizing.ImageResizer.sln", settings => settings.SetConfiguration(configuration));
    }
});
